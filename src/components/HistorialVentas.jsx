                  ...
                  {history.map((venta, index) => (
                    <>
                      <tr>
                        <td
                          colSpan={5}
                          className="border-2 px-4 py-2 border-black bg-green-200"
                        >
                          Venta {index + 1}
                        </td>
                      </tr>
                        ...
                        return (
                          <tr key={item.FechaYHora}>
                            <td className="border border-black py-2">
                              {item.FechaYHora ? new Date(item.FechaYHora).toLocaleString(): ''}
                            </td>
                            <td className="border border-black py-2">
                              {item.name}
                            </td>
                      ...
                      <tr>
                        <td className="bg-blue-200 border border-slate-500  ">{ new Date(venta[0].FechaYHora).getHours() >= 9 && new Date(venta[0].FechaYHora).getHours() < 13 ? 
                        'Turno Mañana':'Turno Tarde'}</td>
                        <td className="bg-blue-200  border border-slate-500  ">{venta[0].Tipo}</td>
